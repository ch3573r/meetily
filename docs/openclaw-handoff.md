...
Use the `openclaw.local` examples as placeholders for your own OpenClaw host.
Use `http://127.0.0.1:8765/meetings/completed` only when the OpenClaw ingest
service runs on the same Windows machine.
