...
```text
ClawScribe_0.5.4-alpha.3_x64_en-US.msi
ClawScribe_0.5.4-alpha.3_x64-setup.exe
SHA256SUMS.txt
BUILD-METADATA.txt
```
...
`msi/ClawScribe_0.5.4-alpha.3_x64_en-US.msi`, so this command verifies cleanly
