...
When **reviewing recordings** in ClawScribe, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **ClawScribe records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing ClawScribe recordings** - Use wired/speakers instead
...
### This is Not a ClawScribe Bug

The issue is in **macOS's Bluetooth audio stack**, not in ClawScribe's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a ClawScribe bug. We've correctly recorded at 48kHz.
...
**A**: Yes! ClawScribe now shows a warning when Bluetooth headphones are active during playback.
...
**Applies To**: ClawScribe v0.0.5+ on macOS
