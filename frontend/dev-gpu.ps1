# GPU-accelerated development script for ClawScribe (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for ClawScribe" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting ClawScribe in development mode..." -ForegroundColor Blue
Write-Host ""
