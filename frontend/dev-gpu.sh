#!/bin/bash
# GPU-accelerated development script for ClawScribe
...
echo -e "${BLUE}🚀 ClawScribe GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting ClawScribe in development mode...${NC}"
echo ""
